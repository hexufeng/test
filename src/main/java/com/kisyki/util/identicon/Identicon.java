package com.kisyki.util.identicon;

import com.kisyki.common.config.SiteConfig;
import com.kisyki.util.HashUtil;
import com.kisyki.util.StrUtil;
import com.kisyki.util.identicon.generator.IBaseGenartor;
import com.kisyki.util.identicon.generator.impl.MyGenerator;
...
//        int ratio = DoubleMath.roundToInt(size / 5.0, RoundingMode.HALF_UP);
    ...
    public void generator(String fileName) {
        ...
        try {
            File file = new File("/opt/upload/file/avatar/" + fileName + ".png");
